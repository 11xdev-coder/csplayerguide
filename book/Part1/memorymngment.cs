namespace book.part1.memorymanagment;

class MemoryManagment
{
    public static void MemoryManagmentFunc()
    {
        Console.WriteLine("Press any key to continue...");
        Console.ReadKey(true);
        Console.Clear();
        Console.Title = "Memory Managment";
        Console.Beep(2000, 250);
        Console.WriteLine("LEVEL 14");
        // Boss battle
        // Hunting the Manticore
        // asking for player 1 for The Manticore's station's distance from city
        byte distance;
        while (true)
        {
